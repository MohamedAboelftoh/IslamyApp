...
import com.islamy_mohamed.persentation.ui.sora_datails.SoraDetailesActivity

class QuranFragment : Fragment() {
   private lateinit var sharedPreferences : SharedPreferences
   private lateinit var viewBinding : FragmentQuranBinding
    private lateinit var adapterRv : QuranAdapter
    ...
    private fun initFunction() {
        adapterRv = QuranAdapter(surahesList)
        viewBinding.RVQuran.adapter = adapterRv
        adapterRv.onItemClickListener = object : QuranAdapter.OnItemClickListener {
            override fun onItemClick(position: Int, name: String) {
                val intent = Intent(context, SoraDetailesActivity::class.java)
